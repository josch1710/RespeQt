...
QString SioWorker::guessDiskCommand(const quint8 command, const quint8 aux1, const quint8 /*aux2*/) {
  ...
  switch (command) {
    case 0x20:
      return tr("[810 Rev. E] Upload and Execute Code or [Speedy 1050] Format Disk Asynchronously");
    case 0x21:
      return tr("Format Single Density Disk");
    case 0x22:
      return tr("Format Enhanced Density Disk");
    case 0x23:
      return tr("[1050, Happy 1050] Run Speed Diagnostic or [Turbo 1050] Service Put");
    case 0x24:
      return tr("[1050, Happy 1050] Run Diagnostic or [Turbo 1050] Service Get");
    case 0x36:
      return tr("[Happy 1050 Rev. 7] Clear Sector Flags (Broadcast)");
    case 0x37:
      return tr("[Happy 1050 Rev. 7] Get Sector Flags (Broadcast)");
    case 0x38:
      return tr("[Happy 1050 Rev. 7] Send Sector (Broadcast)");
    case 0x3F:
      return tr("[Super Archiver 1050, Happy 1050, Speedy 1050, Duplicator 1050] Poll Speed");
    case 0x41:
      return tr("[Happy 810/1050 Rev. 7] Read Track or [Speedy 1050] Add or Delete a Command");
    case 0x42:
      return tr("[Chip 810, Super Archiver 1050] Write Sector using Index or [Happy 810/1050 Rev. 7] Read All Sectors");
    case 0x43:
      return tr("[Chip 810, Super Archiver 1050] Read All Sector Statuses or [Happy 810/1050 Rev. 7] Set Skew Alignment");
    case 0x44:
      return tr("[Chip 810, Super Archiver 1050] Read Sector using Index or [Happy 810/1050 Rev. 7] Read Skew Alignment or [Speedy 1050] Configure Drive and Display");
    case 0x46:
      return tr("[Chip 810, Super Archiver 1050] Write Track");
    case 0x47:
      return tr("[Chip 810, Super Archiver 1050] Read Track (128 bytes)");
    case 0x48:
      if ((aux & 0xFF) == 0x01)
        ...
        return tr("[Happy 810/1050 Rev. 7] Configure Drive");
    case 0x49:
      return tr("[Happy 810/1050 Rev. 7] Write Track with Skew Alignment");
    case 0x4A:
      return tr("[Happy 810/1050 Rev. 7] Init Skew Alignment");
    case 0x4B:
      return tr("[Happy 810/1050 Rev. 7] Prepare backup or [Speedy 1050] Configure Slow/Fast Speed");
    case 0x4C:
      return tr("[Chip 810, Super Archiver 1050] Set RAM Buffer or [Speedy 1050] Jump to Address");
    case 0x4D:
      return tr("[Chip 810] Upload and Execute Code or [Speedy 1050] Jump to Address with Acknowledge");
    case 0x4E:
      return tr("[Super Archiver 1050, Speedy 1050, Turbo 1050, Duplicator 1050] Get PERCOM Block or [Chip 810] Set Shutdown Delay");
    case 0x4F:
      return tr("[Speedy 1050, Turbo 1050, Duplicator 1050] Set PERCOM Block or [Chip 810, Super Archiver 1050] Open CHIP");
    case 0x50:
      return tr("Put Sector (no verify)");
    case 0x51:
      return tr("[Happy 810] Execute code or [Speedy 1050] Flush Write");
    case 0x52:
      return tr("Read Sector");
    case 0x53:
      return tr("Get Status");
    case 0x54:
      return tr("[Chip 810, Super Archiver 1050, 810 Rev. E] Get RAM Buffer");
    case 0x55:
      return tr("[Happy 810] Execute code");
    case 0x56:
      return tr("[Happy 810] Execute code");
    case 0x57:
      return tr("Write Sector (with verify)");
    case 0x5A:
      return tr("[Chip 810, Super Archiver 1050] Set Trace On/Off");
    case 0x60:
      return tr("[Speedy 1050] Write Track at Address");
    case 0x61:
      return tr("[Duplicator 1050] Analyze Track");
    case 0x62:
      return tr("[Super Archiver 1050] Write Fuzzy Sector using Index or [Speedy 1050] Read Track at Address or [Duplicator 1050] Set Drive buffer Mode");
    case 0x63:
      return tr("[Duplicator 1050] Custom Track Format");
    case 0x64:
      return tr("[Duplicator 1050] Set Density Sensing");
    case 0x66:
      return tr("[Super Archiver 1050, Duplicator 1050] Format with Custom Sector Skewing");
    case 0x67:
      return tr("[Super Archiver 1050] Read Track (256 bytes) or [Duplicator 1050] Seek to Track");
    case 0x68:
      return tr("[Speedy 1050] Get SIO Routine size or [Duplicator 1050] Change Drive Hold on Time");
    case 0x69:
      return tr("[Speedy 1050] Get SIO Routine relocated at Address");
    case 0x6A:
      return tr("[Duplicator 1050] Change Drive RPM");
    case 0x6D:
      return tr("[Duplicator 1050] Upload Sector Pattern and Read Track");
    case 0x6E:
      return tr("[Duplicator 1050] Upload Sector Pattern and Write Buffer to Disk");
    case 0x70:
      return tr("[Happy 810/1050 Rev. 7] High Speed Put Sector (no verify)");
    case 0x71:
      return tr("[Super Archiver 1050] Write Fuzzy Sector");
    case 0x72:
      return tr("[Happy 810/1050 Rev. 7] High Speed Read Sector or [Duplicator 1050] Run Uploaded Program at Address");
    case 0x73:
      return tr("[Super Archiver 1050] Set Speed or [Duplicator 1050] Set Load Address");
    case 0x74:
      return tr("[Super Archiver 1050] Read Memory or [Duplicator 1050] Get Sector Data");
    case 0x75:
      return tr("[Super Archiver 1050] Upload and Execute Code or [Duplicator 1050] Upload Data to Drive");
    case 0x76:
      return tr("[Duplicator 1050] Upload Sector Data in Buffer");
    case 0x77:
      return tr("[Happy 810/1050 Rev. 7] High Speed Write Sector (with verify) or [Duplicator 1050] Write Sector with Deleted Data");
    case 0xFF:
      return tr("[810 Rev. E] Execute Code");
    default:
      return tr("Unknown");
  }
#else
  ...
  switch (command) {
    ...
    case 0x22:
      return tr("Format Enhanced Density Disk");
    case 0x23:
      return tr("Run Speed Diagnostic");
    case 0x24:
      return tr("Run Diagnostic");
    case 0x36:
      return tr("Happy Clear Sector Flags (Broadcast)");
    case 0x37:
      return tr("Happy Get Sector Flags (Broadcast)");
    case 0x38:
      return tr("Happy Send Sector (Broadcast)");
    case 0x3F:
      return tr("Poll Speed");
    case 0x41:
      return tr("Happy Read Track");
    case 0x42:
      return tr("Super Archiver Write Sector using Index or Happy Read All Sectors");
    case 0x43:
      return tr("Super Archiver Read All Sector Statuses or Happy Set Skew Alignment");
    case 0x44:
      return tr("Super Archiver Read Sector using Index or Happy Read Skew Alignment");
    case 0x46:
      return tr("Super Archiver Write Track or Happy Write Track");
    case 0x47:
    ...
    case 0x4A:
      return tr("Happy Init Skew Alignment");
    case 0x4B:
      return tr("Happy Prepare backup");
    case 0x4C:
      return tr("Super Archiver Set RAM Buffer");
    case 0x4D:
      return tr("Chip 810 Upload and Execute Code");
    case 0x4E:
      return tr("Get PERCOM Block");
    case 0x4F:
      return tr("Set PERCOM Block or Super Archiver Open CHIP");
    case 0x50:
      return tr("Put Sector (no verify)");
    case 0x51:
    ...
    case 0x57:
      return tr("Write Sector (with verify)");
    case 0x5A:
      return tr("Super Archiver Set Trace On/Off");
    case 0x62:
      return tr("Super Archiver Write Fuzzy Sector using Index");
    case 0x66:
      return tr("Super Archiver Format with Custom Sector Skewing");
    case 0x67:
      return tr("Super Archiver Read Track (256 bytes)");
    case 0x70:
      return tr("Happy High Speed Put Sector (no verify)");
    case 0x71:
      return tr("Super Archiver Write Fuzzy Sector");
    case 0x72:
      return tr("Happy High Speed Read Sector");
    case 0x73:
      return tr("Super Archiver Set Speed");
    case 0x74:
      return tr("Super Archiver Read Memory");
    case 0x75:
      return tr("Super Archiver Upload and Execute Code");
    case 0x77:
      return tr("Happy High Speed Write Sector (with verify)");
    default:
      return tr("Unknown");
  }
#endif
