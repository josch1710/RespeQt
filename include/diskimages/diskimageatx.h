#ifndef RESPEQT_DISKIMAGEATX_H
#define RESPEQT_DISKIMAGEATX_H

#include "diskimages/diskimage.h"

namespace DiskImages {

  class DiskImageAtx : public DiskImage {
  public:
    explicit DiskImageAtx(SioWorkerPtr worker, bool gzipped);
    ...
    quint8 writeSectorHeader(quint8 dataSize, QByteArray &sectorData, quint8 postDataCrc, quint8 preIDField, quint8 postIDCrc,
