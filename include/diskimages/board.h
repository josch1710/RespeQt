...
// pattern to write when Super Archiver formats a track with $08 as a fill byte in a sector ($08 is interpreted as the CRC byte by FDC)
  [[maybe_unused]] static quint8 FDC_CRC_PATTERN[] = {0x08, 0x60, 0x07};

  [[maybe_unused]] static quint8 ARCHIVER_SPEED_CHECK[] = {
  ...
  [[maybe_unused]] static constexpr quint8 ARCHIVER_DIAGNOSTIC[] = {
