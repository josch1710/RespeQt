#!/bin/bash
cqtdeployer -bin "$1" -qmake "$2" $$QMAKE_QMAKE -libDir "$3" -icon "$3"/resources/main-icon/RespeQt.png -extraData \
    ...
    -description "RespeQt" -deployVersion "$4$5" \
    ...
    zip -zipOut "RespeQtLinux_$4$5.zip" qif -qifOut "InstallerRespeQtLinux_$4$5.run" \
    -deployVersion "$4$5" deb -debOut "RespeQtLinux_$4$5.deb"
